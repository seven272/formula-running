...
const Slider = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      descr:
        'Десять километров — это уже не прогулка, это проверка на прочность. Сократи свое время до 60 минут и оставь соперников глотать пыль позади. Докажи, что ты быстрее ракеты!',
  ...
  return (
    <div className={styles.main_slider}>
      ...
      <button
        ...
        onClick={() => routerNavigator.push(`shop/plan/${currentPlan.idPlan}`)}
      >
        смотреть
      </button>
    </div>
