...
const GeneratePdfDocument = ({ planWeeks, pacePlan, titlePlan }) => {
        ...
        {planWeeks.map((week) => (
          ...
          >
            <Text style={styles.weekTitle}>
              ...
              {multipliers.stage[week.stage]} | Объем: {week.weeklyKm}{' '}
              км
            </Text>
              ...
              <View key={idx} style={styles.session}>
                ...
                <Text style={styles.sessionText}>
                  <Text style={styles.sessionTitle}>
                    {s.title} {s.km > 0 ? `(${s.km} км)` : ''}:{' '}
                  </Text>

                  {s.descr}
                  {s.isStrength
                    ? ` ${s.strength.title} ОФП с собственным весом или тренировка в тренажерном зале.`
                    : ''}
                </Text>
              </View>
            ))}
