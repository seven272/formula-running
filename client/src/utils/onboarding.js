      ...
      slides: [
        {
          ...
          subtitle:
            'Ты сможешь купить готовый беговой план или создать свой собственный, а также иметь под рукой важные беговые метрики: пульс, темп, RPE. Тренируйся эффективно!',
        },
      ],
    })
    if (data.result) {
